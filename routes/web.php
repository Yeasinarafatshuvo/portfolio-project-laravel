...
Route::group(['middleware' => ['checkpass']], function(){
    ...
    Route::get('/admin/registration', [LoginController::class, 'registration'])->name('admin.registration');
    ...
    Route::get('/admin/dashboard/project/add', [DashboardController::class, 'project_add'])->name('project.add');
    Route::post('/admin/dashboard/project/store', [DashboardController::class, 'project_store'])->name('project.store');
    Route::get('/admin/dashboard/project/edit/{id}', [DashboardController::class, 'project_edit'])->name('project.edit');
    Route::post('/admin/dashboard/project/update/{id}', [DashboardController::class, 'project_update'])->name('project.update');
